                        ...
                        <div class="employeeList-govern-container">
                            ...
                            <div class="emp-govern-first-input">
                                <div class="emp-govern-sss">
                                    ...
                                    <input type="text" name="empsss" id="" placeholder="Input SSS#" value="<?php echo isset($_GET['empsss']) ? $_GET['empsss'] : ''; ?>">
                                </div>
                                <div class="emp-govern-TIN">
                                    <label for="emptin">TIN</label><br>
                                    <input type="text" name="emptin" id="" placeholder="Input TIN" value="<?php echo isset($_GET['emptin']) ? $_GET['emptin'] : ''; ?>">
                                </div>
                            </div>
                            <div class="emp-govern-second-input">
                                <div class="emp-govern-pagibig">
                                    <label for="emppagibig">Pagibig #</label><br>
                                    <input type="text" name="emppagibig" id="" placeholder="Input Pagibig #" value="<?php echo isset($_GET['emppagibig']) ? $_GET['emppagibig'] : ''; ?>">
                                </div>
                                <div class="emp-govern-TIN">
                                    <label for="empphilhealth">Philhealth #</label><br>
                                    <input type="text" name="empphilhealth" id="" placeholder="Input Philhealth #" value="<?php echo isset($_GET['empphilhealth']) ? $_GET['empphilhealth'] : ''; ?>" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="employeeList-empDetail-container">
                            ...
                            <div class="emp-empDetail-second-input" style=" ">
                                ...
                                <div class="emp-empDetail-bsalary">
                                    ...
                                    <input type="text" id="empbsalary" name="empbsalary" oninput="calculateDailyRate()" required placeholder="Basic Salary" value="<?php echo isset($_GET['empbsalary']) ? $_GET['empbsalary'] : ''; ?>" />
                                </div>
                                <div class="emp-empDetail-drate">
                                    <label for="drate">Daily Rate</label><br>
                                    <input type="text" name="drate" id="drate" placeholder="Daily Rate" required readonly class="form-control" style="height: 40px;" value="<?php echo isset($_GET['drate']) ? $_GET['drate'] : ''; ?>" >
                                </div>
                        ...
                        <div class="employeeList-allowance-container">
                            ...
                            <div class="emp-allowance-first-input">
                                <div class="emp-allowance-transpo">
                                    ...
                                    <input type="text"  name="emptranspo" placeholder="Transpormation Amount" id="numberInput" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value.length > 8) this.value = this.value.slice(0, 8);" value="<?php echo isset($_GET['emptranspo']) ? $_GET['emptranspo'] : ''; ?>">
                                </div>
                                <div class="emp-allowance-meal">
                                    <label for="empmeal">Meal Allowance</label><br>
                                    <input type="text"  name="empmeal" placeholder="Meal Amount" id="numberInput" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value.length > 8) this.value = this.value.slice(0, 8);" value="<?php echo isset($_GET['empmeal']) ? $_GET['empmeal'] : ''; ?>"> 
                                </div>
                                <div class="emp-allowance-internet">
                                    <label for="empinternet">Internet Allowance</label><br>
                                    <input type="text" name="empinternet" placeholder="Internet Amount" id="numberInput" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value.length > 8) this.value = this.value.slice(0, 8);" value="<?php echo isset($_GET['empinternet']) ? $_GET['empinternet'] : ''; ?>"> 
                                </div>
                            </div>
                        </div>
