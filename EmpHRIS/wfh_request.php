...
<div class="main-panel mt-5" style="margin-left: 19%; position: absolute; top: 40px;">
    <div class=" mt-5">
...
<!----------------------------------Class ng header including the button for modal---------------------------------------------->                    
                            <div class="row">
                                ...
                                <button type="button" class="file_wfh btn btn-primary" style="background-color: black; border: none;" data-bs-toggle="modal" data-bs-target="#file_wfh">
                                    File Work From Home
                                    </button>
                                </div>
                            </div> <!--ROW END-->
