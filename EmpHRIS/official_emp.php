        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="validation-message" class="text-danger" style="margin-left: 26px"></div>
                        ...
                        <div class="mb-3" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <input type="date" name="str_date" class="form-control" id="start_date" onchange = "datevalidate()" min="<?php echo date('Y-m-d'); ?>" required>
                                </div>
                                <div class="col-6">
                                <label for="end" class="form-label">End Date</label>
                                <input type="date" name="end_date" class="form-control" id="end_date" onchange = "datevalidate()" min="<?php echo date('Y-m-d'); ?>" required>
                                 </div>
                            </div>
...
<!---------------------------------------Main Panel Start Here --------------------------------------->
        <div class="main-panel mt-5" style="margin-left: 17%; position: absolute; top: 40px">
