...
<?php
    ...
    if(count($_POST) > 0){
        mysqli_query($conn, "UPDATE employee_tb SET fname='".$_POST['fname']."',lname='".$_POST['lname']."',address='".$_POST['address']."',contact='".$_POST['contact']."',cstatus='".$_POST['cstatus']."',gender='".$_POST['gender']."',empdob='".$_POST['empdob']."',empsss='".$_POST['empsss']."',emptin='".$_POST['emptin']."',emppagibig='".$_POST['emppagibig']."',empphilhealth='".$_POST['empphilhealth']."',empbranch='".$_POST['empbranch']."',department_name='".$_POST['department_name']."',empposition='".$_POST['empposition']."',empbsalary='".$_POST['empbsalary']."',drate='".$_POST['drate']."',approver='".$_POST['approver']."',empdate_hired='".$_POST['empdate_hired']."',emptranspo='".$_POST['emptranspo']."',empmeal='".$_POST['empmeal']."',empinternet='".$_POST['empinternet']."',empschedule_type='".$_POST['empschedule_type']."',empstart_date='".$_POST['empstart_date']."',empend_date='".$_POST['empend_date']."',empaccess_id='".$_POST['empaccess_id']."',username='".$_POST['username']."',role='".$_POST['role']."',email='".$_POST['email']."',password='".$_POST['password']."',cpassword='".$_POST['cpassword']."' WHERE id ='".$_POST['id']."'");
