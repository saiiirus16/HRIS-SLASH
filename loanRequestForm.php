        ...
        <div class="row" style="width:92%; margin: auto; margin-top:20px;">
            <div class="col-6" style="padding: 0 30px 0 30px;">  
                <div class="form-group">
                    ...
                    <select name="empid" id="" class="form-control" style="height:50px;">
                ...
                <div class="form-group">
                    ...
                    <select name="loan_type" class="form-control" style="height:50px;">
            ...
            <div class="col-6" style="padding: 0 30px 0 30px;">
                <div class="form-group">
                    ...
                    <input type="date" name="loan_date" class="form-control" style="height:50px;" id="">
                </div>
                <div class="form-group">
                    <label for="payable_amount">Payable Amount</label><br>
                    <input type="number" name="payable_amount" class="form-control" style="height:50px;" id="payable_amount" oninput="calculate()"> 
                </div>
